...
import static seedu.tarence.logic.commands.CommandTestUtil.VALID_WEEKS;
...
import static seedu.tarence.logic.commands.CommandTestUtil.VALID_WEEKS_ODD;
...
import static seedu.tarence.logic.commands.CommandTestUtil.VALID_WEEKS_RANGE;
...
public class AddTutorialCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        TimeTable weeksListTimeTable = new TimeTableBuilder().withWeeks(VALID_WEEKS_LIST).withDuration(VALID_TUTORIAL_DUR)
                .withTime(VALID_TUTORIAL_START_HHMMSS).withDayOfWeek(VALID_TUTORIAL_DAY).build();
        ...
        TimeTable weeksRangeTimeTable = new TimeTableBuilder().withWeeks(VALID_WEEKS_RANGE_LIST)
                .withDuration(VALID_TUTORIAL_DUR).withTime(VALID_TUTORIAL_START_HHMMSS)
        ...
        TimeTable weeksOddTimeTable = new TimeTableBuilder().withWeeks(VALID_WEEKS_RANGE_LIST)
                .withDuration(VALID_TUTORIAL_DUR).withTime(VALID_TUTORIAL_START_HHMMSS)
                .withDayOfWeek(VALID_TUTORIAL_DAY).build();
        ...
        TimeTable weeksDefaultTimeTable = new TimeTableBuilder().withDuration(VALID_TUTORIAL_DUR)
                .withTime(VALID_TUTORIAL_START_HHMMSS).withDayOfWeek(VALID_TUTORIAL_DAY).build();
        Tutorial weeksDefaultTutorial = new TutorialBuilder().withModCode(VALID_MODCODE).withTutName(VALID_TUTORIAL_NAME).
                withTimeTable(weeksDefaultTimeTable).build();
        assertParseSuccess(parser, VALID_MODCODE_DESC + VALID_TUTORIAL_NAME_DESC + VALID_TUTORIAL_DAY_DESC +
